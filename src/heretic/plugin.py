...
class Context:
    ...
    Runtime-backed operations are additive to the stock local-model constructor.
    The legacy private `_model` attribute remains available for local compatibility.
    """
